...
class Stage2Test {
    ...
    /**
     * 생성된 트랜잭션이 몇 개인가? 1개
     * 왜 그런 결과가 나왔을까? default인 Required는 기존 트랜잭션이 존재하면 따르고, 없다면 생성한다.
     */
    @Test
    void testRequired() {
    ...
    /**
     * 생성된 트랜잭션이 몇 개인가? 2개
     * 왜 그런 결과가 나왔을까? requires_new는 기존 트랜잭션이 존재해도 새로운 트랜잭션을 생성한다.
     */
    @Test
     ...
     *  -> supports는 있으면 사용, 없으면 없이 쓴다. / 트랜잭션을 얻긴 하지만 실제 사용하진 않는다.
     */
    @Test
    void testSupports() {
     ...
     * -> mandatory는 있으면 사용, 없으면 에러를 발생한다.
     */
    @Test
    void testMandatory() {
